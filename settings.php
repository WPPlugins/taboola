...
<div class="taboola-container">
    ...
    <form name="install_log" style="display:none;" method="post" action="http://trc.taboola.com/wordpressplugin/log/2/debug">
        <input name="tim" type="hidden" value="<?=date("H:i:s.000")?>">
        <input name="data" type="hideen" value="WORDPRESS_PLUGIN_INSTALL_URL|<?="//{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}"?>">
    </form>
